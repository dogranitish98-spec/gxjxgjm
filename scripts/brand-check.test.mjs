...
// These tests read the Grok agent docs (AGENTS.md, .grok/skills), which are not part of the GitHub repo.
const AGENT_DOCS = existsSync(join(TEMPLATE_ROOT, ".grok/skills/og/SKILL.md"))
  ? {}
  : { skip: "agent docs (.grok/skills, AGENTS.md) not in this checkout" };
...
test("SKILL.md and AGENTS.md name the marker path and bound this script uses", AGENT_DOCS, () => {
...
test("the sections that own the brand-task prohibition never affirm a wait", AGENT_DOCS, () => {
...
test("SKILL.md tells the pass to self-check with the flag this CLI accepts", AGENT_DOCS, () => {
