...
// Hermetic: head-injection defaults read og branding from process.cwd(). Run from an empty
// directory so these template-default expectations do not depend on this repo's own site.json.
