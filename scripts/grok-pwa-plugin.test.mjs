 ...
 *   bundled into the server build as a compiled-in string constant (the
 *   public/ directory is CDN static output on GitHub Pages and not readable
 *   from the function). Compiled by scripts/generate-install-page-template.mjs
 *   (run as a "prebuild" step) from scripts/install-page.html — NOT imported
 *   via `?raw`, because Nitro/Rolldown can fail to resolve raw HTML imports
 ...
 */
import { INSTALL_PAGE_TEMPLATE as installPageTemplate } from "../../scripts/install-page-template.generated.mjs";
